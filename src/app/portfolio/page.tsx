...
import PaperPeelTransition from "@/components/portfolio/PaperPeelTransition";
...
export default function PortfolioPage() {
  ...
  const [transitionType, setTransitionType] = useState<"glass" | "sword" | "glitch" | "paper">("glass");
