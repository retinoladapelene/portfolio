...
export function InfoBoard({ isSurpriseActive, setIsSurpriseActive, isSurpriseEnabled = true }: { isSurpriseActive: boolean, setIsSurpriseActive: (v: boolean) => void, isSurpriseEnabled?: boolean }) {
    return (
        <group position={[0, -0.15, 1.0]} rotation={[-0.6, 0, 0]}>
            ...
            <group position={[0, isSurpriseEnabled ? 0.05 : 0, 0.02]}>
