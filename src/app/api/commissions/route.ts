...
export async function POST(request: Request) {
  try {
    ...
    console.log('--- COMMISSION SUBMISSION ATTEMPT ---');
    ...
    console.log(`[API] Checking active commissions for: ${cleanEmail}`);
    ...
    if (activeComm) {
      console.log(`[API] Blocked submission. Active commission found:`, activeComm);
    ...
    console.log(`[API] No active commission found. Proceeding with insert...`);
    ...
    try {
      ...
      await resend.emails.send({
        ...
        to: process.env.ADMIN_EMAIL || 'prasetiyoyudi94@gmail.com',
                ...
                <div class="card" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 32px; overflow: hidden; box-shadow: 0 20px 50px rgba(168,85,247,0.1); border: 1px solid #F3E8FF;">
                  ...
                  <div class="content" style="padding: 40px;">
                    ...
                    <div style="margin-bottom: 40px; text-align: center;">
                      ...
                      <p style="color: #6B7280; font-size: 12px; font-weight: 500; margin: 8px 0 0 0;">Handle: <span style="color: #9333EA; font-weight: 700;">${socialMedia}</span></p>
                    </div>
                    ...
                    <div style="margin-bottom: 40px;">
                      ...
                      <div style="background: #F9FAFB; padding: 16px; border-radius: 12px; border: 1px solid #F3F4F6; word-break: break-all;">
                        <a href="${references}" style="color: #9333EA; text-decoration: none; font-size: 13px; font-weight: 600;">${references}</a>
                      </div>
                    </div>` : ''}
                ...
                <div class="card" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 32px; overflow: hidden; box-shadow: 0 20px 50px rgba(168,85,247,0.1); border: 1px solid #F3E8FF;">
                  ...
                  <div class="content" style="padding: 48px 40px; text-align: center;">
                    ...
                    <div style="margin: 32px 0; padding: 24px; background: #FDF4FF; border-radius: 24px; border: 1px dashed #D8B4FE;">
                       <p style="margin: 0 0 8px 0; font-size: 10px; font-weight: 900; color: #9333EA; text-transform: uppercase; letter-spacing: 0.2em;">Current Position</p>
                       <p style="margin: 0; font-size: 24px; font-weight: 800; color: #581C87;">Queue #${activeQueueCount || 1}</p>
                    </div>
                ...
                <div class="container" style="font-family: 'Inter', sans-serif; padding: 40px 20px;">
                  <div class="card" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 32px; overflow: hidden; box-shadow: 0 20px 50px rgba(168,85,247,0.1); border: 1px solid #F3E8FF;">
                    ...
                    <div class="content" style="padding: 48px 40px; text-align: center;">
                      ...
                      <div style="margin-top: 48px; padding-top: 32px; border-top: 1px solid #F3F4F6;">
                        <p style="color: #9CA3AF; font-size: 12px; margin: 0;">If you have any questions, feel free to contact me directly.</p>
                      </div>
                    </div>
                  </div>
                </div>
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    // Fetch client info before deletion
    ...
    // Notify client about deletion/cancellation
    if (record) {
      try {
        await resend.emails.send({
          from: 'Moonchaery Studio <onboarding@resend.dev>',
          ...
          html: `
            ...
            <html>
              ...
              <body style="margin: 0; padding: 0; background-color: #FDFCFE;">
                <div class="container" style="font-family: 'Inter', sans-serif; padding: 40px 20px;">
                  <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 32px; overflow: hidden; border: 1px solid #F3F4F6;">
                    <div class="content" style="padding: 48px 40px; text-align: center;">
                      <h2 style="color: #1A1F2B; font-size: 24px; margin: 0 0 16px 0;">Order Update</h2>
                      <p style="color: #6B7280; font-size: 15px; line-height: 1.6;">
                        Hi ${record.client_name},<br><br>
                        Your commission request has been removed from our active queue. If you didn't request this cancellation, please contact us for more details.
                      </p>
                    </div>
                  </div>
                </div>
